                ...
                <div className="settings-modal-scrollable-area"> 
                    ...
                    <div className="settings-section">
                        ...
                        <div className="setting-item">
                            ...
                            <p className="setting-description">
                                Shows extra options like data export and word addition. This setting is saved in your browser.
                            </p>
                        </div>
                    </div>
                    ...
                    {isAdminMode && ( // Only show Data Management if admin mode is enabled
                        <div className="settings-section">
                            ...
                            <div className="setting-item">
                                ...
                                >
                                    <span role="img" aria-label="add icon">➕</span> Add New Word
                                </button>
                                <p className="setting-description">
                                    Opens the form to add a new word with details to your local list.
                                </p>
                            </div>

                            {/* Export Word List Button */}
                            <div className="setting-item" style={{marginTop: '20px'}}> {/* Added some top margin */}
                                <button 
                                ...
                                <p className="setting-description">
                                    Downloads your current word list. Remember to manually update the 'version'
                                    in the downloaded file before replacing your master `scrapedSpan411.json`.
                                </p>
                            </div>
                        </div>
                    )}
