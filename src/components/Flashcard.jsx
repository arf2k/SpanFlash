    ...
    <div className={cardClassName}>
        ...
        <div style={{ marginBottom: "10px" }}>
          ...
          >
            ...
            >
              ...
              {/* "Show Details" Button - visible when card is flipped OR always if desired */}
              {/* For now, let's make it visible when feedback is shown, as per original plan for this modal trigger */}
      ...
      {pair && !showFeedback && (
        ...
        >
          ...
          <button
            type="button"
            onClick={onGetHint} // This is for the MW Hint
      ...
      {/* All detailed info (notes, synonyms, category, Tatoeba examples) is now shown in WordDetailsModal */}
      {/* The trigger for WordDetailsModal (onShowDetails) is active when showFeedback is true via the book icon */}
    </div>
  );
};
