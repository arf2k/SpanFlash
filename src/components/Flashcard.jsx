...
const Flashcard = ({
  ...
  useEffect(() => {
    console.log("[Flashcard] Effect: Resetting answer.");
    setAnswer("");
  }, [pair, showFeedback]);
        ...
        {isHintLoading ? (
          ...
          <>
            ...
            {hint.type === "definitions" && hint.data?.shortdef?.length > 0 ? (
              ...
              <span>: Def details not found.</span>
            ) : null}{" "}
            ...
            {hint.type === "unknown" && (
              <span style={{ color: "orange" }}> Unrecognized hint.</span>
            )}{" "}
          </>
        ) : (
          <span>&nbsp;</span>
